...
print("\n======================================================================================================================================================\n"
      "This program takes in two input files of matrices and multiplies them together | matrix_a + matrix_b = Output\n==================================================="
      "===================================================================================================\n")
...
if a_cols != b_rows:
    ...
    resulting_matrix = [[0 for _ in range(matrix_b[0].__len__())] for _ in range(matrix_a.__len__())]



    # multiplying matrices
    for i in range (matrix_a.__len__()):
        for j in range(matrix_b[0].__len__()):
            for x in range(len(matrix_a[0])):
                # multiplies the matching row to column and adds it to the value of the resulting matrix's
                # respective location
                resulting_matrix[i][j] += float(matrix_a[i][x]) * float(matrix_b[x][j])
